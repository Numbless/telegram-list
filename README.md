...
* [ASMWorld](https://t.me/asmworld) - Канал о программировании на ассемблере и его изучению. Даются краткие примеры, задачи, описания техник и методик. Автор обновляет контент ежедневно.
